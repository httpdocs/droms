  ...
  <body class=""> 
    ...
    <div class="sidebar-nav">
        ...
        <ul id="accounts-menu" class="nav nav-list collapse in">
            <li class="active"><a href="/droms/drom/listform">宿舍信息</a></li>
	 					...
	 					<div class="well">
	    					<table class="table">
							    ...
							    <s:iterator value="list" >					
									<tr>
							          	<td><i><s:property value="dromitory" /></i></td>
							          	<td><s:property value="dromid" /></td>
							          	<td><s:property value="students" /></td>
							          	<td>
							              	<a href="/droms/drom/deleteaction?id=${id }"><i class="icon-remove"></i></a>
							          	</td>
							        </tr>	
								</s:iterator>
							    </tbody>
