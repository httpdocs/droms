  ...
  <body class=""> 
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            ...
            <li class="active"><a href="/droms/student/addform">添加学生信息</a></li>
            ...
            <form action="addaction" method="post">
	            <div id="myTabContent" class="tab-content">
	              ...
	              <div class="tab-pane active in" id="home">
	                  <label>学号</label>
	                  <input type="text" class="input-xlarge" name="stu.studentID" />
	                  <label>姓名</label>
	                  <input type="text" class="input-xlarge" name="stu.name" />
	                  <label>班级</label>
	                  <input type="text" class="input-xlarge" name = "stu.classroom">
	                  <label>手机号</label>
	                  <input type="text" class="input-xlarge"name = "stu.phone">
	                  <label>入住时间</label>
	                  <input type="text" class="input-xlarge" name = "stu.start_time">
	                  <label>辅导员</label>
	                  <input type="text" class="input-xlarge" name = "stu.counselor">
	              </div>
	              <!-- 第二个Tab -->
	              <div class="tab-pane fade" id="profile">
	                  <label>寝室楼</label>
	                  <input type="text" class="input-xlarge" name = "drom.dromitory.id">
	                  <label>寝室号</label>
